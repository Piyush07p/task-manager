        ...
        <nav className='flex items-center justify-between p-2 box-border bg-[#731273] w-[100%]'>
            ...
            <div>
                <ul className='flex  m-2'>
                        <li className='mx-2 text-[0.6rem] sm:text-[1rem]  '>
                            <Link href="/">Home</Link>
                        </li>
                        <li className='mx-2 text-[0.6rem] sm:text-[1rem]  '>
                        ...
                        </li>
                        {
                            (context.currUser)?  
                           <>
                            <li className='mx-2 text-[0.6rem] sm:text-[1rem]   font-bold border-b'>
                            <Link href="/profile">{JSON.parse(localStorage.getItem("userName"))}</Link>
                            </li>
                            <li className='mx-2 text-[0.6rem] sm:text-[1rem]   shadow-sm  bg-gray-900 px-2 rounded-md py-1'>
